...
class ResponseHistoryPinjam {
  ResponseHistoryPinjam({
      this.status, 
      this.message, 
      this.data,});

  ResponseHistoryPinjam.fromJson(dynamic json) {
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = [];
      json['data'].forEach((v) {
        data?.add(DataHistoryPinjam.fromJson(v));
      });
    }
  }
  int? status;
  String? message;
  List<DataHistoryPinjam>? data;
...
class DataHistoryPinjam {
  ...
  DataHistoryPinjam.fromJson(dynamic json) {
    id = json['id'];
    userId = json['user_id'];
    bookId = json['book_id'];
